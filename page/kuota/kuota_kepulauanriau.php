...
$queryy = mysqli_query($conn, "SELECT * FROM kuotakepulauanriau ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotakepulauanriau.*, datapkepriau.pnama, datapkepriau.pumur
                            FROM kuotakepulauanriau, datapkepriau
                            WHERE kuotakepulauanriau.id = datapkepriau.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datakepulauanriau WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Kepulauan Riau</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_kepulauanriau">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_kepulauanriau">
