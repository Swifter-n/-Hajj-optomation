...
$queryy = mysqli_query($conn, "SELECT * FROM kuotamaluku ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotamaluku.*, datapmaluku.pnama, datapmaluku.pumur
                            FROM kuotamaluku, datapmaluku
                            WHERE kuotamaluku.id = datapmaluku.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datamaluku WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Maluku</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_maluku">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_maluku">
