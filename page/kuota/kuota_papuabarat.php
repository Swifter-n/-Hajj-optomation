...
$queryy = mysqli_query($conn, "SELECT * FROM kuotapapuabarat ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotapapuabarat.*, datappapuabarat.pnama, datappapuabarat.pumur
                            FROM kuotapapuabarat, datappapuabarat
                            WHERE kuotapapuabarat.id = datappapuabarat.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datapapuabarat WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Papua Barat</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_papuabarat">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_papuabarat">
