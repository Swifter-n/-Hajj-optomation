...
$queryy = mysqli_query($conn, "SELECT * FROM kuotadkijakarta ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotadkijakarta.*, datapjakarta.pnama, datapjakarta.pumur
                            FROM kuotadkijakarta, datapjakarta
                            WHERE kuotadkijakarta.id = datapjakarta.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datadkijakarta WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; D.K.I Jakarta</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_jakarta">Reset</a>
    </div>
    <div class="col-lg-6">
