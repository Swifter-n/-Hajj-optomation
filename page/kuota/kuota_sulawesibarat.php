...
$queryy = mysqli_query($conn, "SELECT * FROM kuotasulawesibarat ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotasulawesibarat.*, datapsulbar.pnama, datapsulbar.pumur
                            FROM kuotasulawesibarat, datapsulbar
                            WHERE kuotasulawesibarat.id = datapsulbar.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datasulawesibarat WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Sulawesi Barat</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_sulawesibarat">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_sulawesibarat">
