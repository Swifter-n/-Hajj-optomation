...
$queryy = mysqli_query($conn, "SELECT * FROM kuotajawatengah ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotajawatengah.*, datapjateng.pnama, datapjateng.pumur
                            FROM kuotajawatengah, datapjateng
                            WHERE kuotajawatengah.id = datapjateng.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datajawatengah WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Jawa Tengah</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_jawatengah">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_jawatengah">
