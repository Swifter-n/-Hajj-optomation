...
$queryy = mysqli_query($conn, "SELECT * FROM kuotakalimantantengah ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotakalimantantengah.*, datapkalteng.pnama, datapkalteng.pumur
                            FROM kuotakalimantantengah, datapkalteng
                            WHERE kuotakalimantantengah.id = datapkalteng.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datakalimantantengah WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Kalimantan Tengah</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_kalimatantengah">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_kalimantantengah">
