...
$queryy = mysqli_query($conn, "SELECT * FROM kuotasulawesiselatan ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotasulawesiselatan.*, datapsulsel.pnama, datapsulsel.pumur
                            FROM kuotasulawesiselatan, datapsulsel
                            WHERE kuotasulawesiselatan.id = datapsulsel.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datasulawesiselatan WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Sulawesi Selatan</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_sulawesiselatan">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_sulawesiselatan">
