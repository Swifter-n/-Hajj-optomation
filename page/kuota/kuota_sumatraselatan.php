...
$queryy = mysqli_query($conn, "SELECT * FROM kuotasumateraselatan ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotasumateraselatan.*, datapsumateraselatan.pnama, datapsumateraselatan.pumur
                            FROM kuotasumateraselatan, datapsumateraselatan
                            WHERE kuotasumateraselatan.id = datapsumateraselatan.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datasumateraselatan WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Sumatera Selatan</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_sumatraselatan">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_sumatraselatan">
