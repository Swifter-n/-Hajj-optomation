...
$queryy = mysqli_query($conn, "SELECT * FROM kuotasumaterabarat ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotasumaterabarat.*, datapsumaterabarat.pnama, datapsumaterabarat.pumur
                            FROM kuotasumaterabarat, datapsumaterabarat
                            WHERE kuotasumaterabarat.id = datapsumaterabarat.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datasumaterabarat WHERE Status = 1 ORDER BY id ASC");
...
if(isset($_GET['success'])){
    echo "<button type='button' class='close btn-primary' data-dismiss='alert' aria-label='Close'>
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Sumatera Barat</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_sumatrabarat">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_sumatrabarat">
