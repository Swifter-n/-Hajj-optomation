...
$queryy = mysqli_query($conn, "SELECT * FROM kuotajambi ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotajambi.*, datapjambi.pnama, datapjambi.pumur
                            FROM kuotajambi, datapjambi
                            WHERE kuotajambi.id = datapjambi.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datajambi WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Jambi</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_jambi">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_jambi">
