...
$queryy = mysqli_query($conn, "SELECT * FROM kuotabali ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotabali.*, datapbali.pnama, datapbali.pumur
                            FROM kuotabali, datapbali
                            WHERE kuotabali.id = datapbali.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM databali WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Bali</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_bali">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_bali">
