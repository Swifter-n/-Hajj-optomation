...
$queryy = mysqli_query($conn, "SELECT * FROM kuotasulawesiutara ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotasulawesiutara.*, datapsulut.pnama, datapsulut.pumur
                            FROM kuotasulawesiutara, datapsulut
                            WHERE kuotasulawesiutara.id = datapsulut.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datasulawesiutara WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Sulawesi Utara</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_sulawesiutara">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_sulawesiutara">
