...
$queryy = mysqli_query($conn, "SELECT * FROM kuotasumaterautara ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotasumaterautara.*, datapsumaterautara.pnama, datapsumaterautara.pumur
                            FROM kuotasumaterautara, datapsumaterautara
                            WHERE kuotasumaterautara.id = datapsumaterautara.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datasumaterautara WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Sumatera Utara</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_sumatrautara">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_sumatrautara">
