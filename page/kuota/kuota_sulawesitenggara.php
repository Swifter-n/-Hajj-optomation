...
$queryy = mysqli_query($conn, "SELECT * FROM kuotasulawesitenggara ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotasulawesitenggara.*, datapsultenggara.pnama, datapsultenggara.pumur
                            FROM kuotasulawesitenggara, datapsultenggara
                            WHERE kuotasulawesitenggara.id = datapsultenggara.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datasulawesitenggara WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Sulawesi Tenggara</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_sulawesitenggara">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_sulawesitenggara">
