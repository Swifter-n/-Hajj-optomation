...
$queryy = mysqli_query($conn, "SELECT * FROM kuotakalimantanbarat ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotakalimantanbarat.*, datapkalbar.pnama, datapkalbar.pumur
                            FROM kuotakalimantanbarat, datapkalbar
                            WHERE kuotakalimantanbarat.id = datapkalbar.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datakalimantanbarat WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Kalimantan Barat</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_kalimatanbarat">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_kalimantanbarat">
