...
$queryy = mysqli_query($conn, "SELECT * FROM kuotayogyakarta ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotayogyakarta.*, datapyogya.pnama, datapyogya.pumur
                            FROM kuotayogyakarta, datapyogya
                            WHERE kuotayogyakarta.id = datapyogya.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datadiyogyakarta WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; D.I Yogyakarta</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_jogya">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_jogya">
