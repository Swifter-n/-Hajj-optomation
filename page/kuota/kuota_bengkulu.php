...
$queryy = mysqli_query($conn, "SELECT * FROM kuotabengkulu ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotabengkulu.*, datapbengkulu.pnama, datapbengkulu.pumur
                            FROM kuotabengkulu, datapbengkulu
                            WHERE kuotabengkulu.id = datapbengkulu.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM databengkulu WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Bengkulu</h1>
    </div>
</div>
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_bengkulu">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_bengkulu">
