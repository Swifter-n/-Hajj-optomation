...
$queryy = mysqli_query($conn, "SELECT * FROM kuotakalimantanselatan ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotakalimantanselatan.*, datapkalsel.pnama, datapkalsel.pumur
                            FROM kuotakalimantanselatan, datapkalsel
                            WHERE kuotakalimantanselatan.id = datapkalsel.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datakalimantanselatan WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Kalimantan Selatan</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_kalimatanselatan">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_kalimantanselatan">
