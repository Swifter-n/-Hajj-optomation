...
$queryy = mysqli_query($conn, "SELECT * FROM kuotakalimantantimur ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotakalimantantimur.*, datapkaltim.pnama, datapkaltim.pumur
                            FROM kuotakalimantantimur, datapkaltim
                            WHERE kuotakalimantantimur.id = datapkaltim.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datakalimantantimur WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Kalimantan Timur</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_kalimatantimur">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_kalimantantimur">
