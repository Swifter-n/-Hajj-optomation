...
$query = mysqli_query($conn, "SELECT kuotajawatimur.*, datapjatim.pnama, datapjatim.pumur
                            FROM kuotajawatimur, datapjatim
                            WHERE kuotajawatimur.id = datapjatim.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datajawatimur WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Jawa Timur</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_jawatimur">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_jawatimur">
