...
$queryy = mysqli_query($conn, "SELECT * FROM kuotariau ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotariau.*, datapriau.pnama, datapriau.pumur
                            FROM kuotariau, datapriau
                            WHERE kuotariau.id = datapriau.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datariau WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Riau</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_riau">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_riau">
