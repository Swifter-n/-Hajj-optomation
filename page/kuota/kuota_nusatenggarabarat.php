...
$queryy = mysqli_query($conn, "SELECT * FROM kuotanusatenggarabarat ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotanusatenggarabarat.*, datapntb.pnama, datapntb.pumur
                            FROM kuotanusatenggarabarat, datapntb
                            WHERE kuotanusatenggarabarat.id = datapntb.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datanusatenggarabarat WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Nusatenggara Barat</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_nusatenggarabarat">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_nusatenggarabarat">
