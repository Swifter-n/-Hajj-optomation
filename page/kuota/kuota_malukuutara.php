...
$queryy = mysqli_query($conn, "SELECT * FROM kuotamalukuutara ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotamalukuutara.*, datapmalukuutara.pnama, datapmalukuutara.pumur
                            FROM kuotamalukuutara, datapmalukuutara
                            WHERE kuotamalukuutara.id = datapmalukuutara.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datamalukuutara WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Maluku Utara</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_malukuutara">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_malukuutara">
