...
$queryy = mysqli_query($conn, "SELECT * FROM kuotajawabarat ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotajawabarat.*, datapjabar.pnama, datapjabar.pumur
                            FROM kuotajawabarat, datapjabar
                            WHERE kuotajawabarat.id = datapjabar.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datajawabarat WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Jawa Barat</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_jawabarat">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_jawabarat">
