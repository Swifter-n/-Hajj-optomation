...
$queryy = mysqli_query($conn, "SELECT * FROM kuotagorontalo ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotagorontalo.*, datapgorontalo.pnama, datapgorontalo.pumur
                            FROM kuotagorontalo, datapgorontalo
                            WHERE kuotagorontalo.id = datapgorontalo.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datagorontalo WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Gorontalo</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_gorontalo">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_gorontalo">
