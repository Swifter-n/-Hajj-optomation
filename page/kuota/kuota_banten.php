...
$queryy = mysqli_query($conn, "SELECT * FROM kuotabanten ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotabanten.*, datapbanten.pnama, datapbanten.pumur
                            FROM kuotabanten, datapbanten
                            WHERE kuotabanten.id = datapbanten.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM databanten WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Banten</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_banten">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_banten">
