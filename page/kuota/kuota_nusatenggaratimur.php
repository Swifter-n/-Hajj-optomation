...
$queryy = mysqli_query($conn, "SELECT * FROM kuotanusatenggaratimur ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotanusatenggaratimur.*, datapntt.pnama, datapntt.pumur
                            FROM kuotanusatenggaratimur, datapntt
                            WHERE kuotanusatenggaratimur.id = datapntt.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datanusatenggaratimur WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Nusatenggara Timur</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_nusatenggaratimur">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_nusatenggaratimur">
