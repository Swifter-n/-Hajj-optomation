...
$queryy = mysqli_query($conn, "SELECT * FROM kuotapapua ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotapapua.*, datappapua.pnama, datappapua.pumur
                            FROM kuotapapua, datappapua
                            WHERE kuotapapua.id = datappapua.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datapapua WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Papua</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_papua">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_papua">
