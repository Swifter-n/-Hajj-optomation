...
$queryy = mysqli_query($conn, "SELECT * FROM kuotalampung id ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotalampung.*, dataplampung.pnama, dataplampung.pumur
                            FROM kuotalampung, dataplampung
                            WHERE kuotalampung.id = dataplampung.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datalampung WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Lampung</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_lampung">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_lampung">
