...
$queryy = mysqli_query($conn, "SELECT * FROM kuotakepulauanbangkabelitung ORDER BY id ASC");

$query = mysqli_query($conn, "SELECT kuotakepulauanbangkabelitung.*, datapbangka.pnama, datapbangka.pumur
                            FROM kuotakepulauanbangkabelitung, datapbangka
                            WHERE kuotakepulauanbangkabelitung.id = datapbangka.pid
                            ORDER BY id ASC");
$pet = mysqli_query($conn, "SELECT * FROM datakepulauanbangkabelitung WHERE Status = 1 ORDER BY id ASC");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Kuota &raquo; Bangka Belitung</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <a id="reset" href="index.php?reset_bangka">Reset</a>
    </div>
    <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?search_bangka">
