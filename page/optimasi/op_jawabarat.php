<?php
 ...
 $query = mysqli_query($conn, "SELECT * FROM datajawabarat ORDER BY rand() ASC LIMIT 30088");
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        $jumlah = 28588 - 200;
                        if($no < 28588 - 200) {
                        $a = mysqli_query($conn, "SELECT * FROM datajawabarat where id = '$myid' ");
                        $b = mysqli_fetch_array($a);
                            mysqli_query($conn, "insert into kuotajawabarat values ('$myid', '$b[Nama]', '$b[Umur]', '$b[Status_Menikah]', '$b[Pekerjaan]', '$b[Kota]', '$b[Provinsi]', '$b[Negara]', '$b[Record_Haji]', '$b[Riwayat_Penyakit]', '$b[Rentang_Waktu_Pendaftaran]', '$b[Status]')") or die(mysqli_error($conn));
                        }
                        header("location: index.php?lapjawabarat&success");
