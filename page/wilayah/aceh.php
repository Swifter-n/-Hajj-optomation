...
$total_data = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM dataaceh"));
...
if(isset($_POST['submit'])){
    ...
    mysqli_query($conn, "INSERT INTO dataaceh VALUES('', '$nama', '$umur', '$status', '$pekerjaan', '$kota', '$provinsi', '$negara', '$record', '$penyakit', '$waktu_pendaftar')");
    header("location: index.php?aceh");
}

    
    $query = mysqli_query($conn, "SELECT * FROM dataaceh ORDER BY id ASC LIMIT $per_page OFFSET $offset");


?>
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Wilayah &raquo; Aceh</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-md-12">
            <!--<form method="POST" action="index.php?optimasiaceh">
                <input type="text" name="input" placeholder="Jumlah Kuota">
                <input type="submit" name="btn_save" value="Optimasi" onclick="sweet()">
            </form>!-->
            <a class="btn btn-primary" href="index.php?optimasiaceh" onclick="sweet()">Optimasi</a>
                        ...
                        <?php foreach($query as $row){?>
                            <tr>
                               <td>
                                ...
                                <td><?=$row['Status'];?></td>
                                <td class="center"><a href="index.php?aceh-delete=<?=$row['id'];?>" class="btn btn-primary btn-xs" type="button">Delete</a></td>
                            </tr>
                             <?php }?>
                            <?php }?>
                        </tbody>
...
<nav class="text-center">
  ...
  <?php if($cur_page > 1){?>
    <li>
        <a href="index.php?page2=<?php echo $cur_page - 1;?>" aria-label="Previous">
    ...
    <li>
      <a href="index.php?page2=<?php echo $cur_page + 1;?>" aria-label="Next">
