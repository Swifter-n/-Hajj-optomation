...
if(isset($_GET['page15'])){
    $cur_page = $_GET['page15'];
    $cur_page = ($cur_page > 1) ? $cur_page : 1; 
}
$total_data = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM datakepulauanriau"));
...
if(isset($_POST['submit'])){
    ...
    mysqli_query($conn, "INSERT INTO datakepulauanriau VALUES('', '$nama', '$umur', '$status', '$pekerjaan', '$kota', '$provinsi', '$negara', '$record', '$penyakit', '$waktu_pendaftar')");
    header("location: index.php?kepulauan_riau");
}

    
    $query = mysqli_query($conn, "SELECT * FROM datakepulauanriau ORDER BY id ASC LIMIT $per_page OFFSET $offset");


?>
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Wilayah &raquo; Kepulauan Riau</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-md-12">
            <!--<form method="POST" action="index.php?optimasikepulauanriau">
             ...
             <a class="btn btn-primary" href="index.php?optimasikepulauanriau" onclick="sweet()">Optimasi</a>
...
<nav class="text-center">
  ...
  <?php if($cur_page > 1){?>
    <li>
        <a href="index.php?page15=<?php echo $cur_page - 1;?>" aria-label="Previous">
    ...
    <li>
      <a href="index.php?page15=<?php echo $cur_page + 1;?>" aria-label="Next">
