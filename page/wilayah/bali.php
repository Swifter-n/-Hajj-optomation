...
$total_data = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM databali"));
...
if(isset($_POST['submit'])){
    ...
    $query = mysqli_query($conn, "SELECT * FROM databali ORDER BY id ASC LIMIT $per_page OFFSET $offset");


?>
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Wilayah &raquo; Bali</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-md-12">
            <!--<form method="POST" action="index.php?optimasibali">
             ...
             <a class="btn btn-primary" href="index.php?optimasibali" onclick="sweet()">Optimasi</a>
...
<nav class="text-center">
  ...
  <?php if($cur_page > 1){?>
    <li>
        <a href="index.php?page1=<?php echo $cur_page - 1;?>" aria-label="Previous">
    ...
    <li>
      <a href="index.php?page1=<?php echo $cur_page + 1;?>" aria-label="Next">
