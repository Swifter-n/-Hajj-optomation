...
$total_data = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM datajawabarat"));
...
if(isset($_POST['submit'])){
    ...
    mysqli_query($conn, "INSERT INTO datajawabarat VALUES('', '$nama', '$umur', '$status', '$pekerjaan', '$kota', '$provinsi', '$negara', '$record', '$penyakit', '$waktu_pendaftar')");
    header("location: index.php?jawa_barat");
}

    
    $query = mysqli_query($conn, "SELECT * FROM datajawabarat ORDER BY id ASC LIMIT $per_page OFFSET $offset");


?>
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Wilayah &raquo; Jawa Barat</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-md-12">
            <!--<form method="POST" action="index.php?optimasijawabarat">
             ...
             <a class="btn btn-primary" href="index.php?optimasijawabarat" onclick="sweet()">Optimasi</a>
...
<nav class="text-center">
  ...
  <?php if($cur_page > 1){?>
    <li>
        <a href="index.php?page8=<?php echo $cur_page - 1;?>" aria-label="Previous">
    ...
    <li>
      <a href="index.php?page8=<?php echo $cur_page + 1;?>" aria-label="Next">
