...
$total_data = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM datadkijakarta"));
...
if(isset($_POST['submit'])){
    ...
    mysqli_query($conn, "INSERT INTO datadkijakarta VALUES('', '$nama', '$umur', '$status', '$pekerjaan', '$kota', '$provinsi', '$negara', '$record', '$penyakit', '$waktu_pendaftar')");
    header("location: index.php?jakarta");
}

    
    $query = mysqli_query($conn, "SELECT * FROM datadkijakarta ORDER BY id ASC LIMIT $per_page OFFSET $offset");


?>
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Wilayah &raquo; Jakarta</h1>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-md-12">
            <!--<form method="POST" action="index.php?optimasijakarta">
             ...
             <a class="btn btn-primary" href="index.php?optimasijakarta" onclick="sweet()">Optimasi</a>
